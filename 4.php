...
$sql = "CREATE TABLE IF NOT EXISTS productes(
    ...
    print("<form action='41.php' method='post'>");
    print("<p>Cif: <input type='text' name='cif' placeholder=$cif></p>");
    print("<p>Nom: <input type='text' name=nom placeholder=$nom></p>");
    print("<p>Cognom 1: <input type='text' name='cog1' placeholder=$cog1> Cognom 2: <input type='text' name='cog2' placeholder=$cog2></p>");
    print("<p>Adreça: <input type='text' name='adreca' placerholder=$dir></p>");
    print("<p>Telf: <input type='text' name='telf' placerholder=$telf></p>");
